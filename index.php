        ...
        <div class="container navbar">
            ...
            <nav class="nav-links">
                ...
                <?php if(isset($_SESSION['user'])): ?>
                    <a href="user/chart.php">Keranjang</a>
                    <a href="user/dashboard.php">Akun Saya</a>
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <?php if(isset($_SESSION['user'])): ?>
                        <form action="user/chart.php" method="POST">
                    ...
                    <?php else: ?>
                        <a href="user/register.php" class="btn" style="width:100%; display:block; text-align:center;">Login untuk Beli</a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endwhile; ?>
